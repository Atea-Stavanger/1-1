...
locals {
  subscription_ids_effective = merge(
    {
      management   = var.subscription_id
      connectivity = var.subscription_id
      identity     = var.subscription_id
      security     = var.subscription_id
    },
