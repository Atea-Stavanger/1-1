...
management_group_settings = {
  ...
  # Single-subscription mode: do not place subscriptions into landing-zone management groups.
  # Workloads are deployed into resource groups in the configured subscription.
